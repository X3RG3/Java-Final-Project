...
public class Accessories extends JFrame implements MouseListener, ActionListener {
    ...
    public Accessories(String s1){
        ...
        p1 = 3500;p2=5000;p3=1243;p4=2431;p5=2343;p6=4324;
        bill=0;

        titlelbl1 = new JLabel("Gaming Keyboard");
        ...
        titlelbl2 = new JLabel("Razer Headphone");
        ...
        titlelbl3 = new JLabel("Gaming Mouse");
        ...
        titlelbl5 = new JLabel("Gaming Mouse Pro");
        ...
        titlelbl6 = new JLabel("Pookie Headphone");
