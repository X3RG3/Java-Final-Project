...
public class Games extends JFrame implements MouseListener, ActionListener {
    ...
    private JLabel bgimglbl,titlelbl1,titlelbl2,titlelbl3,titlelbl4,titlelbl5,titlelbl6,titleplbl1,titleplbl2,titleplbl3,titleplbl4,titleplbl5,titleplbl6;
    private ImageIcon icon,bgimg;
    private JButton logoutbtn,backbtn,prbtn1,prbtn2,prbtn3,prbtn4,prbtn5,prbtn6,chkoutbtn,rmvitemsbtn;
    ...
    public Games(String s1){
        ...
        p1 = 4800;p2=3000;p3=3700;p4=6300;p5=4290;p6=3500;
        bill = 0;

        titlelbl1 = new JLabel("RDR-2");
        ...
        titlelbl2 = new JLabel("God of War");
        ...
        titlelbl3 = new JLabel("Assasian's Creed");
        ...
        titleplbl3 = new JLabel(p3+" taka");
        titleplbl3.setBounds(700,270,90,20);
        titleplbl3.setForeground(Color.WHITE);
        titleplbl3.setHorizontalAlignment(JLabel.CENTER);
        titleplbl3.setFont(f2);
        panel.add(titleplbl3);

        titlelbl4 = new JLabel("Cyberpunk");
        ...
        titleplbl4 = new JLabel(p4+" taka");
        titleplbl4.setBounds(220,590,90,20);
        titleplbl4.setForeground(Color.WHITE);
        titleplbl4.setHorizontalAlignment(JLabel.CENTER);
        titleplbl4.setFont(f2);
        panel.add(titleplbl4);


        titlelbl5 = new JLabel("Ready or Not");
        ...
        titleplbl5 = new JLabel(p5+" taka");
        titleplbl5.setBounds(460,590,90,20);
        titleplbl5.setForeground(Color.WHITE);
        titleplbl5.setHorizontalAlignment(JLabel.CENTER);
        titleplbl5.setFont(f2);
        panel.add(titleplbl5);

        titlelbl6 = new JLabel("NFS-Most Wanted");
        ...
        rmvitemsbtn = new JButton("Remove Items");
        rmvitemsbtn.setBounds(232, 680, 260, 40);
        rmvitemsbtn.setForeground(Color.WHITE);
        rmvitemsbtn.setBackground(c2);
        rmvitemsbtn.setFocusPainted(false);
        rmvitemsbtn.setFont(f2);
        rmvitemsbtn.addActionListener(this);
        panel.add(rmvitemsbtn);

        chkoutbtn = new JButton("Checkout");
        chkoutbtn.setBounds(532, 680, 260, 40);
        chkoutbtn.setForeground(Color.WHITE);
        chkoutbtn.setBackground(c2);
        chkoutbtn.setFocusPainted(false);
        chkoutbtn.setFont(f2);
        ...
        bgimg = new ImageIcon("Images/gbg.png");
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource()==logoutbtn){
            ...
            JOptionPane.showMessageDialog(null, "Added To Cart");
            calcBill(p6);
        } else if (ae.getSource()==rmvitemsbtn) {
            JOptionPane.showMessageDialog(null, "All Items Removed From Cart");
            bill = 0;
        } else if (ae.getSource()==chkoutbtn) {
            this.setVisible(false);
            PayBill pb = new PayBill(usern,bill);
            pb.setVisible(true);
        }
